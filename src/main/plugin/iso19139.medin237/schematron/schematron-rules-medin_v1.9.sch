...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="1.7">
  ...
  <sch:pattern fpi="MedinUniqueResourceIdentifier">
    ...
    <sch:p>
      Mandatory element (for datasets and series of datasets).  Multiple occurrences allowed.  Free text.
    </sch:p>
    <sch:p>
  ...
  <sch:pattern fpi="MedinDateOfPublication">
    ...
    <sch:rule context="/*/gmd:identificationInfo">
      ...
      <sch:assert test="count(*/gmd:citation/*/gmd:date/*/gmd:dateType[*/@codeListValue='publication']) + count(*/gmd:extent/*/gmd:temporalElement) &gt;= 1">
