...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  -->
  <xsl:template mode="mode-iso19139" match="gml:duration[$schema='iso19139.medin237']" priority="200">
  ...
  <xsl:template mode="mode-iso19139" match="gml:beginPosition[$schema='iso19139.medin237']|gml:endPosition[$schema='iso19139.medin237']|gml:timePosition[$schema='iso19139.medin237']"
                priority="200">
  ...
  <xsl:template mode="mode-iso19139" priority="200" match="gmd:useLimitation[$schema='iso19139.medin237' and gmx:Anchor]">
